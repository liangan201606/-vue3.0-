              ...
              <td>
                <div class="goods">
                  ...
                  <div>
                    ...
                    <!-- 选择规格组件 -->
                    <!-- 要获取新的商品信息 将老的购物车信息和新的购物车信息组合成一块 item.skuId 老的信息 -->
...
export default {
  ...
  setup() {
    ...
    const updateCartSku = (oldSkuId, newSku) => {
      store.dispatch('car/updateCartSku', { oldSkuId, newSku })
      console.log('1')
    }
    // 结算
    ...
    const checkout = () => {
      // 1.判断商品，且提示
      // 2.判断是否已经登录，未登录 弹出确认框
      // 3.导航守卫进行登录拦截
      if (store.getters['car/selectedTotal'] === 0) return Message({ text: '至少选中一件商品才能结算' })
