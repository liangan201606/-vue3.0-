<template>
  ...
  <div class="sub-filter" v-if="filterData && !filterLoading">
    ...
    <div class="item" v-for="item in filterData.saleProperties" :key="item.id">
      ...
      <div class="body">
        <a @click="changeProp(item,props.id) :class="{active:prop.id === item.properties.selectedProp}" href="javascript:;" v-for="prop in item.properties" :key="prop.id">{{ prop.name }}</a>
      </div>
    </div>
  </div>
  <!-- 在加载中显示加载效果 -->
