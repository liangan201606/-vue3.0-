    ...
    <div class="container">
      ...
      <div class="cart">
        <table>
          <thead>
            <tr>
              <th width="120"><XtxCheckbox :modelValue="$store.getters['car/isCheckAll']">全选</XtxCheckbox></th>
      ...
      <div class="action">
        ...
        <div class="total">
          共 {{$store.getters['car/validTotal']}} 件商品，已选择 {{$store.getters['cart/selectedTotal']}} 件，商品合计：
