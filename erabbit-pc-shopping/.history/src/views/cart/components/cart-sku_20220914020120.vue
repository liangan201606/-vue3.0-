<template>
  <div class="cart-sku" ref="target">
    ...
    <div class="layer" v-if="visable">
      ...
      <XtxButton v-if="!loading" type="primary" size="mini" style="margin-left: 60px" @click="submit">确认</XtxButton>
    </div>
  </div>
</template>
<script>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    return { visable, toggle, target, goods, loading, submit, changeSku }
  }
}
</script>
