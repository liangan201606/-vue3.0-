<template>
  <div class="account-box">
    ...
    <Form class="form" :validation-schema="mySchema" v-slot="{errors}" autocomplete="off">
      <template v-if="!isMsgLogin">
        <div class="form-item">
          <div class="input">
            <i class="iconfont icon-user"></i>
            <Field :class="{ error: errors.account }" v-model="form.account" name="mobile" type="text" placeholder="请输入用户名" />
          </div>
        ...
        <div class="form-item">
          ...
          <div class="error" v-if="errors.password"><i class="iconfont icon-warning" />
            <i class="iconfont icon-user"></i>
            {{ errors.password }}
          </div>
        </div>
      ...
      <template v-else>
        <div class="form-item">
          ...
          <div class="error" v-if="errors.mobile"><i class="iconfont icon-warning" />
            <i class="iconfont icon-user"></i>
            {{ errors.mobile }}
          </div>
        </div>
        <div class="form-item">
          ...
          <div class="error" v-if="errors.code"><i class="iconfont icon-warning" />
            <i class="iconfont icon-user"></i>
            {{ errors.code }}
          </div>
        </div>
