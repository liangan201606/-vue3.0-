  ...
  <Form class="xtx-form">
    <div class="xtx-form-item">
      <div class="field">
        ...
        <Field :class="{ err: errors.accountApi }" name="account" class="input" type="text" placeholder="请输入用户名" />
      </div>
      <div v-if="errors.accountApi" class="error">{{ errors.account }}</div>
    </div>
    <div class="xtx-form-item">
      <div class="field">
    ...
    <div class="xtx-form-item">
      ...
      <div v-if="errors.rePassword" class="error">{{ errors.reqPassword }}</div>
    </div>
