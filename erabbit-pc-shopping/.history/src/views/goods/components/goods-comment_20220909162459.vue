<template>
  <div class="goods-comment">
    ...
    <div class="sort">
      <span>排序：</span>
      <a href="javascript:;" @change="reqParams.sortField == nll" :class="{active:reqParams.sortField===null}">默认</a>
      <a href="javascript:;"  :class="{active:reqParams.sortField==='praiseCount'}">最新</a>
      <a href="javascript:;"  :class="{active:reqParams.sortField==='createTime'}">最热</a>
    </div>
    <!-- 评价列表 -->
    <div class="list">
      <div class="item">
