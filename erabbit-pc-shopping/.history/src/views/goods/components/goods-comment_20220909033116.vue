  ...
  <div class="goods-comment">
    <div class="head">
      ...
      <div class="tags">
        ...
        <div class="dd">
          <a href="javascript:;" @click="changeTag" :class="{ active: currentTagIndex===i }" v-for="(item, i) in commentInfo.tags" :key="item.id">{{ item.title }}({{ item.tagCount }})</a>
        </div>
      </div>
    </div>
    <div class="sort">
...
export default {
  ...
  setup() {
    ...
    return { commentInfo, currentTagIndex }
  }
}
</script>
