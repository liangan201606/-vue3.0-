<template>
  <div class="goods-comment">
    ...
    <div class="sort">
      ...
      <a href="javascript:;" @click="reqParams.sortField == null" :class="{active:reqParams.sortField==='praiseCount'}">最新</a>
      <a href="javascript:;" @click="reqParams.sortField == null" :class="{active:reqParams.sortField==='createTime'}">最热</a>
    </div>
    <!-- 评价列表 -->
    <div class="list">
      <div class="item">
