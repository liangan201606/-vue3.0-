<template>
  <div class="goods-comment">
    ...
    <div class="sort">
      ...
      <a href="javascript:;" @click="reqParams.sortField = 'praiseCount'" :class="{ active: reqParams.sortField === 'praiseCount' }">最新</a>
      <a href="javascript:;" @click="reqParams.sortField = 'createTime'" :class="{ active: reqParams.sortField === 'createTime' }">最热</a>
    </div>
    <!-- 评价列表 -->
    <div class="list">
      <div class="item">
...
export default {
  ...
  setup() {
    ...
    // 初始化或者筛选条件改变后，获取列表数据。
    watch(reqParams, () => {
      (props.goods.id, reqParams)
      commentList.value = data.refindCommentListByGoodssult.items
    },{ immediate: true })
