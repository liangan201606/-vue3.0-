...
<template>
  <div class="member-home">
    ...
    <HomePanel title="我的收藏">
      <GoodsItem v-for="i in 4" :key="i" :goods="collectGoods" />
    </HomePanel>
    <!-- 足迹 -->
    <HomePanel title="我的足迹">
      <GoodsItem v-for="i in 4" :key="i" :goods="HistoryGoods" />
    </HomePanel>
    <!-- 猜你 -->
    <GoodsRelevant />
  </div>
...
import { ref } from 'vue'
import { findCollect, findbrowseHistory } from '@/api/order'
export default {
  name: 'MemberHome',
  components: {
    HomeOverview,
  ...
  setup() {
    ...
    return { goods, HistoryGoods, HistoryGoods }
  }
}
</script>
