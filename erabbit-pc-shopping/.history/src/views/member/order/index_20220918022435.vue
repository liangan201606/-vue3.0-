<template>
  <div class="member-order">
    ...
    <div class="order-list">
      ...
      <OrderItem @on-cancel="handlerCancel" @on-delete="handlerDelete" @on-confirm="handlerConfirm" @on-logist="handlerLogist" v-for="order in orderList" :key="order.id" :order="order" />
    </div>
...
import { findOrderList, deleteOrder, receiptOrder, logisticsOrder } from '@/api/order'
...
export default {
  ...
  setup() {
    ...
    return { activeName, changeTab, orderStatus, orderList, loading, total, reqParams, ...useCancel(), handlerDelete, ...useConfirm(), ...useLogists() }
  }
}
// 取消订单逻辑
const useCancel = () => {
...
const useLogists = () => {
  ...
  const handlerLogist = (order) => {}
  return { handlerLogist, logisticsOrderCom }
}
</script>
