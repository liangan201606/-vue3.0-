<template>
  <div class="member-order">
    ...
    <div class="order-list">
      ...
      <OrderItem @on-cancel="handlerC" v-for="order in orderList" :key="order.id" :order="order" />
    </div>
...
export default {
  ...
  setup() {
    ...
    return { activeName, changeTab, orderStatus, orderList, loading, total, reqParams }
  }
}
</script>
