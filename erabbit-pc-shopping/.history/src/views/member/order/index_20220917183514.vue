<template>
  <div class="member-order">
    ...
    <div class="order-list">
      ...
      <OrderItem @on-cancel="handlerCancel" @on-delete="handlerDelete" v-for="order in orderList" :key="order.id" :order="order" />
    </div>
...
export default {
  ...
  setup() {
    ...
    watch(reqParams, () => {}, { immediate: true })
    const getOrderList = () => {
    ...
    return { activeName, changeTab, orderStatus, orderList, loading, total, reqParams, ...useCancel(), handlerDelete }
  }
}
// 取消订单逻辑
const useCancel = () => {
