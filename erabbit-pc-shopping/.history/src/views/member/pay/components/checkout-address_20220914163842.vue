<template>
  <div class="checkout-address">
    ...
    <div class="action">
      ...
      <XtxButton @click="visibleDialog = true" class="btn">添加地址</XtxButton>
    </div>
  </div>
  <!-- 对话框组件 -->
  <XtxDialog title="切换收货地址" v-model:visible="visibleDialog">
    <div class="text item" v-for="item in list" :key="item.id" @click="selectedAddress=item" :class="{active: selectedAddress && selectedAddress.id}">
      <ul>
        <li>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    return { showAddress, visibleDialog, open, openDialog, selectedAddress }
  }
}
</script>
