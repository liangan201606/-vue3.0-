<template>
  ...
  <!-- 添加编辑组件-添加收获地址 -->
  <AddressEdit ref="addressEdit" @on-success="successHeadear"></AddressEdit>
</template>
<script>
import { ref } from 'vue'
...
export default {
  ...
  setup(props, { emit }) {
    ...
    return { showAddress, visibleDialog, open, openDialog, selectedAddress, confirmAddress, openAddressEdit, addressEdit }
  }
}
</script>
